...
function start() {
    ...
    mtns = new BG(builderMtns.img, bg1,  GameEngine.height/(1+4)+120, builderMtns.width, builderMtns.height, PLA_L, 20);
    add(mtns);
    var trs = new BG(builderTrs.img, bg2, GameEngine.height/(1+4)+150, builderTrs.width, builderTrs.height, PLA_L, 10);
    add(trs);
    //var hils = new BG(builderHils.img,"#19542A",builderHils.height-20,builderHils.width,builderHils.height,0,4);
    //add(hils);

    floor = {x:0,y:0,height:26};
